      ...
      <nav className={styles.nav}>
        ...
        <ul className={navList}>
          <li className={styles.navListLink}>
            <Link onClick={() => setState(!state)} to="#about">
              About
            </Link>
          </li>
          <li className={styles.navListLink}>
            <Link onClick={() => setState(!state)} to="#previous-year">
              Hackville 2019
            </Link>
          </li>
          <li className={styles.navListLink}>
            <Link onClick={() => setState(!state)} to="#faq">
              FAQ
            </Link>
          </li>
          <li className={styles.navListLink}>
            <Link onClick={() => setState(!state)} to="#get-involved">
              Get Involved
            </Link>
          </li>
          <li className={styles.navListLink}>
